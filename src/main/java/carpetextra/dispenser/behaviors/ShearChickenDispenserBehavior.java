...
public class ShearChickenDispenserBehavior extends OptionalDispenseItemBehavior {
    ...
    protected ItemStack execute(BlockSource pointer, ItemStack stack) {
        ...
        List<Chicken> chickens = world.getEntities(EntityTypes.CHICKEN, frontBlockBox, EntitySelector.LIVING_ENTITY_STILL_ALIVE.and((chickenEntity) -> !((Animal) chickenEntity).isBaby()));
