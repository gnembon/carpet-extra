...
public class CarpetExtraSettings
{
    ...
    @Rule(
            desc = "Enables `/ping` for players to get their ping.",
            category = {COMMAND, EXTRA}
    )
    ...
    @Rule(
            desc = "Only creepers spawn in jungle temples.",
            category = {FEATURE, EXTRA}
    )
    public static boolean creeperSpawningInJungleTemples = false;

    @Rule(
            desc = "Disables player entity collision.",
            category = {EXTRA, CREATIVE, EXPERIMENTAL}
    )
    ...
    @Rule(
            desc = "Dispensers can place blocks.",
            category = {CREATIVE, EXTRA, DISPENSER}
    )
    ...
    @Rule(
            desc = "Dispensers with hoes can till soil.",
            category = {EXTRA, FEATURE, DISPENSER}
    )
    ...
    @Rule(
            desc = "Reintroduce the Dragon Egg Bedrock breaking bug from 1.12.",
            category = {EXTRA, EXPERIMENTAL}
    )
    ...
    @Rule(
            desc = "Cobblestone crushed by falling anvils makes sand.",
            category = {EXTRA, EXPERIMENTAL, FEATURE}
    )
    public static boolean renewableSand = false;

    @Rule(
            desc = "Skeletons turn into wither skeletons when struck by lightning.",
            category = {FEATURE, EXTRA}
    )
    ...
    @Rule(
            desc = "Only strays spawn in igloos.",
            category = {FEATURE, EXTRA}
    )
